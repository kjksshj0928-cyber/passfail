...
# -*- coding: utf-8 -*-
"""
qc_thresholds_autoscan_unified_pro_ml_rev5_0_shotaware.py
---------------------------------------------------------
...
실행 흐름:
1) GUI 실행: python qc_thresholds_autoscan_unified_pro_ml_rev5_0_shotaware.py
...
def launch_gui():
    ...
    shotfrm = ttk.LabelFrame(left, text="Shot-Aware / Shape Guards (rev5.0)")
